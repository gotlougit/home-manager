...
let
  ...
  # Darwin support completely disabled since correct paths are not known
  isDarwin = false;
  ...
  mozillaConfigPath =
    if isDarwin then "Library/Application Support/Mozilla" else ".local/share/tor-browser/TorBrowser/Data";

  firefoxConfigPath = if isDarwin then
    "Library/Application Support/Firefox"
  else
    "${mozillaConfigPath}/Browser";
  ...
  options = {
    programs.tor-browser = {
      ...
      package = mkOption {
        ...
        default = pkgs.tor-browser-bundle-bin;
        defaultText = literalExpression "pkgs.tor-browser-bundle-bin";
